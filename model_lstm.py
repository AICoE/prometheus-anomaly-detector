            ...
            for lstm_cell_count_ in lstm_cells:
                for dense_cell_count_ in dense_cells:
                    ...
                    if loss > loss_:
                        ...
                        dense_cell_count = dense_cell_count_import logging
from prometheus_api_client import Metric
from keras.models import Sequential
from keras.layers import Dense
from keras.layers import LSTM
...
class MetricPredictor:
    ...
    def train(self, metric_data=None, prediction_duration=15):
        ...
        _LOGGER.info("Initializing LSTM Model with params: {0} {1}".format(self.lstm_cell_count, self.dense_cell_count))
        self.model = self.get_model(self.lstm_cell_count, self.dense_cell_count)
        _LOGGER.info(
